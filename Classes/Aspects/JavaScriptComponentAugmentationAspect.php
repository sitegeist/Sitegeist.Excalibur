...
class JavaScriptComponentAugmentationAspect
{
	...
	/**
     * @Flow\Around("setting(Sitegeist.Excalibur.features.javaScriptComponentAugmentation.enable) && method(PackageFactory\AtomicFusion\FusionObjects\ComponentImplementation->evaluate())")
